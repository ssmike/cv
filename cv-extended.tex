...
\cventry{2017 -- 2018}{Software engineer}{Yandex}{Moscow}{}{news.yandex.com infrastructure team.
    ...
    \begin{itemize}%
        ...
        \item designed and developed a local falut-tolerant document storage for news indexer based on COW balanced trees optimized and write-ahead logging which enabled us to greatly simplify news ranking pipeline by using long-term data snapshots, build consistent data snapshots on historical data and created a possibility to reproduce exact inputs for ml-models.
    \end{itemize}
