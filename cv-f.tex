...
\cventry{2022 -- Now}{Senior software engineer}{Yandex}{Moscow}{}{\href{https://ydb.tech/}{YDB} (is an open-source newsql dbms) query processor team.
    ...
    \begin{itemize}
        \item Reworked the predicate pushdown logic to make use of calculated (non-literal) read ranges for table reads. As a result allowed users to efficiently use complex filters and allowed to choose secondary indices automatically.
        ...
        \item Implemented cpu isolation for user workloads to use in OLAP/HTAP scenarios.
    \end{itemize}
    \underline{Technologies}: C++ 20, actor model, Python, Go%
}%
\cventry{2018 -- 2022}{Senior software engineer (got promoted from middle in 2019)}{Yandex}{Moscow}{}{yandex base search team.
    \newline{}
    \underline{Duties}:
    \begin{itemize}
...
\cventry{2016 -- 2018}{Software engineer (got promoted from junior in 2017)}{Yandex}{Moscow}{}{news.yandex.com infrastructure team.
    ...
    \end{itemize}
    \underline{Key technologies}: C++ 14, Zookeeper, Redis, Lua, MapReduce, event-drivern architecture%
}
...
\cvitem{Spanish}{Limited working proficiency}
